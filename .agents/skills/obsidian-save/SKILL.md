---
name: obsidian-save
description: "Save everything worth keeping from this conversation to the vault Triggers: save this, save the conversation, save to vault, obsidian save. Use proactively: trigger this whenever the conversation produces something worth capturing, without waiting to be asked."
metadata:
  category: vault
---
