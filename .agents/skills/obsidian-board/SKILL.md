...
2. If a board name is given, search the boards folder for it (fuzzy match), resolved per `.agents/skills/obsidian-core/references/folder-map.md` (wiki-style `boards/`, Obsidian-style `Boards/`)
