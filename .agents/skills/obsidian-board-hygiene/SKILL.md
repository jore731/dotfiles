---
name: obsidian-board-hygiene
description: "Bulk-triage a kanban board - surface stale items and archive, reschedule, or mark them done in one pass Triggers: clean up my board, triage my board, board hygiene, archive stale tasks, my board is a mess. Use only when the user explicitly asks for it."
metadata:
  category: vault
---
