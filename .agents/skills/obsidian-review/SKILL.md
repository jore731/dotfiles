...
description: "Generate a structured weekly or monthly review note from vault history Triggers: weekly review, monthly review, review my week, review my month. Use only when the user explicitly asks for it."
metadata:
  category: thinking
---
...
7. Save to the reviews folder resolved per `.agents/skills/obsidian-core/references/folder-map.md` (read the vault's `_CLAUDE.md` Folder Map first; wiki-style `wiki/reviews/`, Obsidian-style `Reviews/`), named `YYYY-MM-DD - Weekly Review.md` (or Monthly)
