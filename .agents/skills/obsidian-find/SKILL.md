---
name: obsidian-find
description: "Smart vault search - returns results with context, not just filenames Triggers: find in vault, search my notes, where is, what did I write about. Use only when the user explicitly asks for it."
metadata:
  category: vault
---
