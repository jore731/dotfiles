---
name: obsidian-recap
description: "Summarize a time period from the vault - today, week, or month Triggers: recap today, recap the week, summarize the week, month recap. Use only when the user explicitly asks for it."
metadata:
  category: vault
---
...
3. List all daily notes in the range from the daily folder, resolved per `.agents/skills/obsidian-core/references/folder-map.md` (wiki-style `wiki/daily/`, Obsidian-style `Daily/`)
