...
4. If not found: create `Full Name.md` in the entities folder (resolved per `.agents/skills/obsidian-core/references/folder-map.md` - wiki-style `wiki/entities/`, Obsidian-style `People/`) with full frontmatter schema
