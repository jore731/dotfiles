...
Use these self-contained vector libraries when a diagram needs Azure or Microsoft Entra icons:

- `libraries/microsoft-azure-cloud-icons/azure-public-service-icons.excalidrawlib` — 714 Azure icons
- `libraries/microsoft-azure-cloud-icons/microsoft-entra-icons.excalidrawlib` — 14 Microsoft Entra icons

The source SVGs and rebuild command are alongside the libraries. Rebuild them with `/import-azure-icon-libraries` when the checked-in SVG sources change.
