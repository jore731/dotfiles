...
description: "Multi-turn Socratic brainstorm - one question per turn until the idea converges, then a design note with named alternatives and one recommendation Triggers: brainstorm this, brainstorm with me, think this through with me, help me design this, interview me about this idea. Use only when the user explicitly asks for it."
metadata:
  category: thinking
---
...
Save to the ideas/concepts folder (resolved per `.agents/skills/obsidian-core/references/folder-map.md`), named `YYYY-MM-DD - Brainstorm - <topic>.md`, `type: brainstorm`, thinking-tool schema in `.agents/skills/obsidian-core/references/ai-first-rules.md`. Structure:
