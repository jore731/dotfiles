...
description: "Generate a visual canvas map of your vault - see the shape of your second brain and how knowledge connects Triggers: visualize vault, vault map, canvas of vault, show me the vault shape. Use only when the user explicitly asks for it."
metadata:
  category: meta
---
